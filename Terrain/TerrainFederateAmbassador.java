 ...
 * {@link TerrainFederate}. It will log information about any callbacks it
...
public class TerrainFederateAmbassador extends NullFederateAmbassador
{
	...
	public void announceSynchronizationPoint( String label, byte[] tag )
	{
		...
		if( label.equals(TerrainFederate.READY_TO_RUN) )
	    ...
	    throws FederateInternalError
	{
		...
		if( interactionClass.equals(federate.terrainUploadHandle) )
		{
			builder.append( " (TerrainUpload)" );
			Terrain.getInstance().terrainUpdate();
		}
